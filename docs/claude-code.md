...
For a private authenticated deployment, set `HEALTH_MCP_CLAUDE_TOKEN` outside the repository
and give Claude Code a token distinct from every other client. The
